...
public class ServerGameControllerImpl extends AbstractGameController implements ServerGameController {
    ...
    public ServerGameControllerImpl(GameSession gameSession) {
        super(gameSession);
    }

    public ServerGameControllerImpl() {
        super();
    }
